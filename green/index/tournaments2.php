      ...
      <div class="general general-results tournaments">
           ...
           <div id="c-calend" class="top-score-title right-score col-md-9">
                ...
                <div class="accordion" id="section1"><i class="fa fa-calendar-o"></i>JANUARY<span></span></div>
                    ...
                    <div class="accordion" id="section2"><i class="fa fa-calendar-o"></i >FEBRUAR<span ></span></div>
                    <div class="acc-content">
                            <div class="col-md-1 acc-title">Cat.</div>
                            <div class="col-md-2 acc-title">Fecha</div>
                            <div class="col-md-3 acc-title">Tournament</div>
                    ...
                    <div class="accordion" id="section3"><i class="fa fa-calendar-o"></i>MARCH</span></div>
                    <div class="acc-content">
                            <div class="col-md-1 acc-title">Cat.</div>
                            <div class="col-md-2 acc-title">Fecha</div>
                            <div class="col-md-3 acc-title">Tournament</div>
                    ...
                    <div class="accordion" id="section4"><i class="fa fa-calendar-o"></i>APRIL</span></div>
                    <div class="acc-content">
                            <div class="col-md-1 acc-title">Cat.</div>
                            <div class="col-md-2 acc-title">Fecha</div>
                            <div class="col-md-3 acc-title">Tournament</div>
